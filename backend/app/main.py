...
from .routers import auth, onboarding, me, admin, contact, syllabus, career_lab, sim, payments, lumina_test_users
...
app.include_router(lumina_test_users.router, prefix=API_PREFIX)
